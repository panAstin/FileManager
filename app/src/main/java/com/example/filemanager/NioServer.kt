...
/**
 * Created by 11046 on 2018/3/15.
 * NIOSocket服务端
 */
class NioServer(private var address: InetAddress){
    ...
    fun init() {
        ...
        server.socket().bind(InetSocketAddress(address,8081), 1024)
        // 设置为非阻塞模式, 这个非常重要
